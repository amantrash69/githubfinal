...
async def process_new_message(client, message):
    ...
    if not target_names:
        print("❌ No routes found for this source. Ignoring.")
        conn.close()
        return
    ...
    try:
        async with client.conversation(LINK_BOT_USERNAME, timeout=15) as conv:
            ...
            # FIX 1: Safely handle messages, ignoring WebPage previews
        ...
        # FIX 2: Send directly to the Target Username instead of Numeric ID
